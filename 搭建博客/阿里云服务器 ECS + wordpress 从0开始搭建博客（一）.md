...
![!\[\[Pasted image 20241018202326.png\]\]](assets/image2.png)
如果访问公网IP没有相应的话，可以在安全组这里：
![!\[\[Pasted image 20241018202424.png\]\]](assets/image4.png)
![!\[\[Pasted image 20241018202501.png\]\]](assets/image5.png)
...
返回结果类似如下所示，表示MySQL已成功安装，MySQL的版本为8.0.39。
![!\[\[Pasted image 20241018202940.png\]\]](assets/image6.png)
3. 运行以下命令，启动MySQL服务。
```sql
...
sudo php -v
```
![!\[\[Pasted image 20241018203406.png\]\]](assets/image7.png)
# 安装 wordpress
...
```
来对该文件进行编辑：
![!\[\[Pasted image 20241018212631.png\]\]](assets/image8.png)
...
![!\[\[Pasted image 20241018211638.png\]\]](assets/image9.png)
## 安装中文
...
然后在更新这里就可以正常更新啦！
![!\[\[Pasted image 20241018220254.png\]\]](<assets/Pasted image 20241018220254.png>)
